...
<body>
    <div class="row">
        ...
        <div class="col-md-6 col-md-offset-0 col-md-push-0">
                <h1 class="text-center text-success">DTR - OVERTIME</h1>
        ...
        jQuery(document).ready(function() {
            ...
            $('#scancode').on('change',function(){
                ...
                Webcam.snap( function(data_uri) {
                    ...
                    $.post("<?php echo base_url("overtime/logtime"); ?>",{scancode:scancode,image:raw_image_data},function(result){
                        ...
                        $.post("<?php echo base_url("overtime/messagestatus"); ?>",function(html){
