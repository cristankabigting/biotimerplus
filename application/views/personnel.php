                            ...
                            <div class="portlet light bordered">
                                <div class="portlet-title tabbable-line">
                                    <div class="caption caption-md">
                                        ...
                                        <span class="caption-subject font-blue-madison bold uppercase">Personnel Records</span>
                                    </div>
                                ...
                                <div class="portlet-body">
                                    <div class="tab-content">
                                                ...
                                                <div class="row">
                                                    ...
                                                    <div class="col-md-3">
                                                        <div class="form-group">
                                                            ...
                                                            <select name="allowance_type" id="allowance_type" class="bs-select form-control">
                                                    ...
                                                    <div class="col-md-3">
                                                        <div class="form-group">
                                                            ...
                                                            <select name="calendartype" id="calendartype" class="bs-select form-control">
                                                                <option value="TC">Tuesday</option>
                                                                <option value="SC">Sunday</option>
                                                ...
                                                <div class="row">
                                                    <div class="col-md-3">
                                                        <div class="form-group">
                                                            ...
                                                            <input name="basicsalary" id="basicsalary" type="text" placeholder="" class="form-control" maxlength="12" /> 
                                                        </div>                                                        
                                                    </div>
                                                    ...
                                                    <div class="col-md-3">
                                                        <div class="form-group">
                                                            ...
                                                            <input name="allowances" id="allowances" type="text" placeholder="" class="form-control" maxlength="12" /> 
                                                        </div>                                                        
                                                    </div>
                                                    ...
                                                    <div class="col-md-12">
                                                        ...
                                                        <div class="col-md-6">
                                                            <div class="form-group">
                                                                ...
                                                                <select name="manual_entry_time_type" id="manual_entry_time_type" class="bs-select form-control">
                                                                    <option></option>
                                                        ...
                                                        <div class="col-md-6">
                                                            ...
                                                            <button id="btnLogTimeRecord" type="button" class="btn ladda-button grey-mint" data-style="expand-right" style="width:100%;"> <i class="fa fa-clock-o"></i> Log Time Record</button>
                                                        </div>    
                                                    </div>
                                                </div>
                                                <div class="row">&nbsp;</div>
                                        ...
                                        <div class="tab-pane" id="tab_1_4">
                                            <div class="row">
                                                <div class="col-md-4">
                                                    <button id="btnSummarizeAdjustment" type="button" class="btn ladda-button grey-mint" data-style="expand-right" style="width:100%;"> <i class="fa fa-calculator"></i> Summarize Selected Adjustments</button>
                                                </div>
                                                <div class="col-md-4">
                                                    <button id="btnDeleteAdjusment" type="button" class="btn ladda-button grey-mint" data-style="expand-right" style="width:100%;"> <i class="fa fa-remove"></i> Delete Selected Adjustments</button>
                                                </div>
                                            </div>
        ...
        <script>
            ...
            jQuery(document).ready(function(){
                ...
                var handleDropDown = function() {
                    ...
                    $('#allowance_type').select2({placeholder:'Select an Allowance Type',width:null});
                    $('#calendartype').select2({width:null});
                    ...
                    $('#manual_entry_time_type').select2({width:null});
                            ...
                            var interval = setInterval( function() {
                                ...
                                if( progress === 1 ) {
                                    ...
                                    $.post("<?php echo base_url("personnel/getEmployeeData"); ?>",{employeecode:employeecode},function(data){
                                        ...
                                        $('#calendartype').val(obj.calendartype).trigger('change');
                ...
                $('#btnEditLog').click(function(){
                    var ids = $.map($('#table-logs').bootstrapTable('getSelections'), function (row) {
                        ...
                        $('#manual_entry_time_type').val(row.timetype).trigger('change');
                ...
                $('#btnLogTimeRecord').click(function(){
                    ...
                    )
                    {
                        var data = {
                            ...
                            'timetype'      : $('#manual_entry_time_type').val()
                        };

                        $.post("<?php echo base_url("personnel/logTimeRecord"); ?>",{data:data},function(result){
                            getEmployeeLogs($('#manual_entry_employeecode').val());
                            handleMessageStatus.init();
                            //$('#table-logs').bootstrapTable('refresh');
                            ...
                            $('#manual_entry_login').val('');
                            $('#manual_entry_logout').val('');
                            $('#manual_entry_time_type').val('').trigger('change');
                            alert('done');
                        });
                                       ...
                                       $('#manual_entry_logdate').focus();
                                        ...
                                        if(!$('#manual_entry_login').val()) {
                                            ...
                                            if(!$('#manual_entry_logout').val()) {
                                                ...
                                                if(!$('#manual_entry_time_type').val()) {
                                                    alert('Error: Please select a Log Type.');
                                                    $('#manual_entry_time_type').focus();
                                                }                                            
                                            }                                        
                                        }
                                    }                                
